...
class _TrafficSettingsPageState extends State<TrafficSettingsPage> {
  ...
  Future<void> _loadSettings() async {
    ...
    print('[TrafficSettings] Loaded settings: enabled=${settings['enabled']}, interval=${settings['intervalMinutes']}min, radius=${settings['radiusMiles']}mi');
    setState(() {
  ...
  Future<void> _saveSettings() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(_isEnabled ? 'Traffic monitoring started' : 'Traffic monitoring stopped'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Traffic Detection Settings', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: _isEnabled ? Colors.green.shade200 : Colors.grey.shade300,
                        ),
                      ),
                      child: Text(
                        _isEnabled ? 'Monitoring Active' : 'Monitoring Inactive',
                        style: TextStyle(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Slider(
                      ...
                      divisions: maxDetectionRadiusMiles - minDetectionRadiusMiles,
                    ...
                    Row(
                      children: [
                        ...
                        Switch(
                          ...
                          onChanged: _isEnabled
                              ? (value) {
                                  setState(() => _notifyOnlySerious = value);
                                  _saveSettings();
                                }
                              : null,
                        ),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () async {
                          print('[TrafficSettings] Manual traffic check triggered');
                          await BackgroundTrafficService.performTrafficCheck();
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Traffic check completed - check console logs'),
